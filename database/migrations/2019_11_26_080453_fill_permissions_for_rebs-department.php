...
class FillPermissionsForRebsDepartment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRebsDepartment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rebs-department',
            'admin.rebs-department.index',
            'admin.rebs-department.create',
            'admin.rebs-department.show',
            'admin.rebs-department.edit',
            'admin.rebs-department.delete',
        ]);
