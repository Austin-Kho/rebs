...
class FillPermissionsForRebsBankAccount extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRebsBankAccount constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rebs-bank-account',
            'admin.rebs-bank-account.index',
            'admin.rebs-bank-account.create',
            'admin.rebs-bank-account.show',
            'admin.rebs-bank-account.edit',
            'admin.rebs-bank-account.delete',
        ]);
