...
class FillPermissionsForRebsCompany extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRebsCompany constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rebs-company',
            'admin.rebs-company.index',
            'admin.rebs-company.create',
            'admin.rebs-company.show',
            'admin.rebs-company.edit',
            'admin.rebs-company.delete',
        ]);
