...
return [
    ...
    */
    ...
    'after_or_equal'       => ':attribute은(는) 반드시 :date 이후 날짜이거나 같아야 합니다.',
    ...
    'before_or_equal'      => ':attribute은(는) 반드시 :date 이전 날짜이거나 같아야 합니다.',
    'between'              => [
    ...
    'dimensions'           => ':attribute은(는) 유효하지 않은 이미지 치수입니다.',
    ...
    'gt'                   => [
        ...
        'file'    => ':attribute은(는) 반드시 :value 킬로바이트 보다 커야 합니다.',
        'string'  => ':attribute은(는) 반드시 :value 자리보다 커야 합니다.',
        'array'   => ':attribute은(는) 반드시 :value 아이템보다 커야 합니다.',
    ],
    'gte'                  => [
        'numeric' => ':attribute은(는) 반드시 :value 보다 크거나 같아야 합니다.',
        'file'    => ':attribute은(는) 반드시 :value 킬로바이트 보다 크거나 같아야 합니다.',
        'string'  => ':attribute은(는) 반드시 :value 자리보다 크거나 같아야 합니다.',
        'array'   => ':attribute은(는) 반드시 :value 아이템보다 크거나 같아야 합니다.',
    ],
    'image'                => ':attribute은(는) 반드시 이미지여야 합니다.',
    'in'                   => '선택된 :attribute은(는) 유효하지 않습니다.',
    'in_array'             => ':attribute 필드에 :other이 존재하지 않습니다.',
    'integer'              => ':attribute은(는) 반드시 정수여야 합니다.',
    'ip'                   => ':attribute은(는) 반드시 유효한 IP 주소여야 합니다.',
    'ipv4'                 => ':attribute은(는) 반드시 유효한 IPv4 주소여야 합니다.',
    'ipv6'                 => ':attribute은(는) 반드시 유효한 IPv6 주소여야 합니다.',
    'json'                 => ':attribute은(는) 유효한 Json 문자열이어야 합니다.',
    'lt'                   => [
        'numeric' => ':attribute은(는) 반드시 :value 보다 작아야 합니다.',
        'file'    => ':attribute은(는) 반드시 :value 킬로바이트 보다 작아야 합니다.',
        'string'  => ':attribute은(는) 반드시 :value 자리보다 작아야 합니다.',
        'array'   => ':attribute은(는) 반드시 :value 아이템보다 작아야 합니다.',
    ],
    'lte'                  => [
        'numeric' => ':attribute은(는) 반드시 :value 보다 작거나 같아야 합니다.',
        'file'    => ':attribute은(는) 반드시 :value 킬로바이트 보다 작거나 같아야 합니다.',
        'string'  => ':attribute은(는) 반드시 :value 자리보다 작거나 같아야 합니다.',
        'array'   => ':attribute은(는) 반드시 :value 아이템보다 작거나 같아야 합니다.',
    ],
    'max'                  => [
    ...
    'mimetypes'            => ':attribute은(는) 반드시 다음의 파일 타입이어야 합니다: :values.',
    'min'                  => [
    ...
    'required_unless'      => ':other이(가) :value 일때를 제외하고 :attribute 필드는 필수입니다.',
    ...
    'required_without_all' => ':values이(가) 없을 경우 :attribute 필드는 필수입니다.',
